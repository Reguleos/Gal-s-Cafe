...
if (isset($_SESSION['account_id']) && isset($_SESSION['username'])) {
     ...
     if (!$conn) {
          ...
          $reports_sql = "SELECT * FROM `reports` WHERE `account_id`=$account_id;"; 
...
<html> 
     ...
     <body> 
          ...
          <div class="form">
               ...
               <?php } ?>
               <form action="Customer-Report-Action.php" method="post" id="sugg"> 
                    ...
                    <p class="label"> Describe your experience: </p>
                    <?php if (isset($_GET['report'])) { 
                         $report = $_GET['report']; ?>
                         <textarea form="sugg" name="report" placeholder="Enter report here..."><?php echo $report ?></textarea>
                    <?php } else { ?>
                         <textarea form="sugg" name="report" placeholder="Enter report here..."></textarea>
                    <?php } ?>
