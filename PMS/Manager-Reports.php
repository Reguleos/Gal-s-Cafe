...
<body>
	...
	<div class="buttons">
        <a href="Manager-Reports.php?category=all"> <button class="body"> All Categories </button> </a>
        <a href="Manager-Reports.php?category=food"> <button class="body"> Food </button> </a>
        <a href="Manager-Reports.php?category=beverage"> <button class="body"> Beverage </button> </a>
        <a href="Manager-Reports.php?category=service"> <button class="body"> Service </button> </a>
    </div>
