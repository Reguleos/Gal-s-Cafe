...
<body>
	...
	<div class="buttons">
        <a href="Manager-Suggestions.php?category=all"> <button class="body"> All Categories </button> </a>
        <a href="Manager-Suggestions.php?category=food"> <button class="body"> Food </button> </a>
        <a href="Manager-Suggestions.php?category=beverage"> <button class="body"> Beverage </button> </a>
        <a href="Manager-Suggestions.php?category=service"> <button class="body"> Service </button> </a>
    </div>
