...
<body>
	...
	<div class="buttons">
        <a href="Manager-Rating-and-Review.php?category=all"> <button class="body"> All Categories </button> </a>
        <a href="Manager-Rating-and-Review.php?category=food"> <button class="body"> Food </button> </a>
        <a href="Manager-Rating-and-Review.php?category=beverage"> <button class="body"> Beverage </button> </a>
        <a href="Manager-Rating-and-Review.php?category=service"> <button class="body"> Service </button> </a>
    </div>
