...
if (isset($_POST['uname']) && 
	...
	$user_data = '&uname='. $uname. '&first_name='. $first_name. '&last_name='. $last_name. '&birthday='. $birthday. '&age='. $age. '&sex='. $sex. '&address='. $address. '&e_mail='. $e_mail. '&mobile_number='. $mobile_number;
	...
	if (empty($uname)){
		...
		if (mysqli_num_rows($result) > 0) {
			...
			VALUES('$uname', '$pass', '$first_name', '$last_name', 'Customer', '$birthday', '$age', '$sex', '$address', '$e_mail', '$mobile_number')";
